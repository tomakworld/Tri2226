...
function qOf(phase, wi, rec, P){
  ...
  if (phase==="p2") return {
    q1:{ t:"Q1·I 間歇", x:`熱身3km;${rec?4:5+Math.min(wi,2)}x1000m @${I} 慢跑2-3分恢復;緩和2km${rf} — I總量上限為週跑量8%,單堂不超過10km`, v:`${rec?4:5+Math.min(wi,2)}x1000` },
  ...
  if (phase==="p4") return {
    q1:{ t:"Q1·T鞏固", x:`熱身3km;2x20分 T @${T} 休4分;緩和2km${rf} — T總量以不超過週跑量10%為原則,若當週量偏低改為2x15分`, v:"2x20分T" },
